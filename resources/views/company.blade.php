    ...
    <div class="container">
        ...
        <div class="row mt-5">
            <div class="col">
                ...
                {{$company->about}}
                <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pretium eleifend erat id finibus. Donec tristique purus vitae urna varius, sed laoreet nisl efficitur.
                </p>
            </div>
        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-8">
                ...
                <div class="card mb-3">
                    <div class="card-body">
                        <h5 class="card-title">{{$job->tirle}}</h5>
